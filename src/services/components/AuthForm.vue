  ...
  <div class="auth-card">
    ...
    <div>
      <el-form ref="form" :model="form" :label-position="'top'">
        ...
        <div class="btn-group">
          <Button v-for="btn in buttons.filter(b => b !== 'Восстановить пароль')" :key="btn.getStatus()"
            :color-swap="true" :text="btn.label" :button="btn.disabled"
            :button-class="btn.isSubmit ? 'btn-active' : 'btn'" @click="authButtonClick(btn)" />
        </div>
      </el-form>
    </div>
  </div>
